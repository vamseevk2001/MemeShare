package vamsee.application.memeshare
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadMeme(){
        ...
        //singleton request :
        //volley should not have multiple request
        MySingleton.getInstance(this).addToRequestQueue(jsonObjectRequest)
    }

    fun share(view: View) {
        val intent = Intent(Intent.ACTION_SEND)
        intent.putExtra(Intent.EXTRA_TEXT, "Hey check out this cool meme..... $currentMemeUrl")
        //type:
        intent.type = "text/plain"

        //now we have to create a chooser
